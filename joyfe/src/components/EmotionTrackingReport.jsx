    ...
    <div className="emotion-tracking-container">
      ...
      <div className="card-container">
        ...
        <div className="grid-2-1">
          <div>
            ...
            <ul>
              <li className="list-item">
                <svg className="icon icon-green" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="list-item">
                <svg className="icon icon-amber" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            <h4 className="font-medium text-dark mb-2">Recommendations</h4>
            <ul>
              <li className="list-item">
                <svg className="icon icon-indigo" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <span className="text-gray">Introduce more score-based challenges</span>
              </li>
              <li className="list-item">
                <svg className="icon icon-indigo" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <span className="text-gray">Increase difficulty of score-based tasks</span>
              </li>
              <li className="list-item">
                <svg className="icon icon-indigo" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <span className="text-gray">Try visual memory exercises to build confidence</span>
              </li>
            </ul>
          </div>
        </div>
